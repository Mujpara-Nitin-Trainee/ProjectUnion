function validateForm() {
    ...
    function isEmpty(val) {
        ...
        if (isEmpty(firstname)) {
            ...
            let message = document.getElementById('firstname_error');
            message.innerHTML = "FirstName Should not contain Special Character or numbers";
            message.style.color = "red";
            isvalid = false;
        }
        ...
        if (isEmpty(lastname)) {
            ...
            let message = document.getElementById('lastname_error');
            message.innerHTML = "Lastname Should not contain Special Character or numbers";
            message.style.color = "red";
            isvalid = false;
        }
        ...
        degree.forEach((e) => {
            if (e.value == "" || e.value == undefined) {
                ...
                let message = document.getElementById('education_error');
                message.innerHTML = "Degree Should not contain Special Character or numbers";
                message.style.color = "red";
                isvalid = false;
            }
            ...
            if (board[i].value == "" || board[i].value == undefined) {
                ...
                let message = document.getElementById('education_error');
                message.innerHTML = "Board Should not contain Special Character or numbers";
                message.style.color = "red";
                isvalid = false;
            }
        ...
        if ((hindi_check.checked == true) && (hindi_read.checked == false && hindi_speak.checked == false && hindi_write.checked == false)) {
            let message = document.getElementById('language_error');
            message.innerHTML = "Plz select Any One Option of hindi*";
            message.style.color = "red";
            isvalid = false;
        } else if (hindi_read.checked == true || hindi_speak == true || hindi_write == true) {
        ...
        if ((gujrati_check.checked == true) && (gujrati_read.checked == false && gujrati_speak.checked == false && gujrati_write.checked == false)) {
            let message = document.getElementById('language_error');
            message.innerHTML = "Plz select Any One Option of Gujrati*";
            message.style.color = "red";
            isvalid = false;
        } else if (gujrati_read.checked == true || gujrati_speak == true || gujrati_write == true) {
        ...
        if ((english_check.checked == true) && (english_read.checked == false && english_write.checked == false && english_speak.checked == false)) {
            console.log("Y000");
            let message = document.getElementById('language_error');
            message.innerHTML = "Plz select Any One Option of English*";
            message.style.color = "red";
            isvalid = false;
        } else if (english_read.checked == true || english_speak == true || english_write == true) {
            english_check.checked = true;
        }


        if (hindi_check.checked == false && gujrati_check.checked && false && english_check.checked == false) {
            let message = document.getElementById('language_error');
        ...
        if (php_check.checked == true && (php_beginner.checked == false && php_mediator.checked == false && php_expert.checked == false)) {
            let message = document.getElementById('language_error');
            message.innerHTML = "Select Any Option of PHP or remove check from PHP*";
            message.style.color = "red";
            isvalid = false;
        } else if (php_beginner.checked == true || php_mediator.checked == true || php_expert.checked == true) {
        ...
        if (mysql_check.checked == true && (mysql_beginner.checked == false && mysql_mediator.checked == false && mysql_expert.checked == false)) {
            let message = document.getElementById('language_error');
            message.innerHTML = "Select Any Option of Mysql or remove check from Mysql*";
            message.style.color = "red";
            isvalid = false;
        } else if (mysql_beginner.checked == true || mysql_mediator.checked == true || mysql_expert.checked == true) {
        ...
        if (laravel_check.checked == true && (laravel_beginner.checked == false && laravel_mediator.checked == false && laravel_expert.checked == false)) {
            let message = document.getElementById('language_error');
            message.innerHTML = "Select Any Option of Laravel or remove check from laravel*";
            message.style.color = "red";
            isvalid = false;
        } else if (laravel_beginner.checked == true || laravel_mediator.checked == true || laravel_expert.checked == true) {
        ...
        if (oracle_check.checked == true && (oracle_beginner.checked == false && oracle_mediator.checked == false && oracle_expert.checked == false)) {
            let message = document.getElementById('language_error');
            message.innerHTML = "Select Any Option of Oracle or remove check from Oracle*";
            message.style.color = "red";
            isvalid = false;
        } else if (oracle_beginner.checked == true || oracle_mediator.checked == true || oracle_expert.checked == true) {
            oracle_check.checked = true;
        }

        if (php_check.checked == false && mysql_check.checked == false && laravel_check.checked == false && oracle_check.checked == false) {
            let message = document.getElementById('language_error');
        ...
        company_name.forEach((e) => {
            if (e.value == "" || e.value == undefined) {
                ...
                let message = document.getElementById('work_error');
                message.innerHTML = "Company Name Should not contain Special Character or numbers";
                message.style.color = "red";
                isvalid = false;
            }

            if (designation[j].value == "" || designation[j].value == undefined) {
                let message = document.getElementById('work_error');
                message.innerHTML = "designation Filed Required*";
                message.style.color = "red";
                isvalid = false;
            } else if (!designation[j].value.match(letters)) {
                let message = document.getElementById('work_error');
                message.innerHTML = "designation Should not contain Special Character or numbers";
                message.style.color = "red";
                isvalid = false;
            }

            let isValidateDate1 = new Date(start_date[j].value);
            let isValidateDate2 = new Date(end_date[j].value);

            //	console.log(isValidateDate);

            let datearr1 = start_date[j].value.split("/");
            let datearr2 = end_date[j].value.split("/");

            //console.log(datearr.length);

            if (start_date[j].value == "" || start_date[j].value == undefined) {
                let message = document.getElementById('work_error');
                message.innerHTML = "Year Field Requird*";
                message.style.color = "red";
                isvalid = false;
            ...
            if (end_date[j].value == "" || end_date[j].value == undefined) {
                let message = document.getElementById('work_error');
                message.innerHTML = "Year Field Requird*";
                message.style.color = "red";
                isvalid = false;
        ...
        if (isEmpty(name)) {
            ...
            let message = document.getElementById('refrence_error');
            message.innerHTML = "Refer Name  Should not contain Special Character or numbers";
            message.style.color = "red";
            isvalid = false;
        }
        ...
        if (isEmpty(relationship)) {
            ...
            let message = document.getElementById('refrence_error');
            message.innerHTML = "Refer Relationship Should not contain Special Character or numbers";
            message.style.color = "red";
            isvalid = false;
        }
