...
router.get("/user/activate", userAuthenticatation)
...
router.get('/user/setPassword', userSetPassword);
...
router.post("/user/pagging/searching/delimiterSearch", auth, pageDelimiterSearch);
